...
%% Datos de la portada
\def\tituloportada {Apuntes de Intro a la Sustenta}
\def\autordeldocumento {Francisco Muñoz Guajardo}
\def\repositorio {github.com/LaTeX-pm/Apuntes-Intro-Sustenta}
\def\fecha {\today}
\def\nombredelcurso {Introducción a la Sustentabilidad en la Ingeniería}
\def\codigodelcurso {IQ3451}
